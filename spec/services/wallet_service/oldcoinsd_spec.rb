...
describe WalletService::Oldcoinsd do
  ...
  describe 'WalletService::Oldcoinsd' do
    ...
    let(:deposit_wallet) { Wallet.find_by(gateway: :oldcoinsd, kind: :deposit) }
    let(:hot_wallet) { Wallet.find_by(gateway: :oldcoinsd, kind: :hot) }
